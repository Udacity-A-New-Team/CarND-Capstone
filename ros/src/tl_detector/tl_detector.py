...
LIGHT_CLASSIFIER_MODE = 1 # 0 = classifier is ON, 1 = classifier is off, using simulator data, 2 = classifier is OFF, gathering camera images and labels for training NN
...
class TLDetector(object):
	...
	#We use simulator light state to gather images+labels to train network
		...
		save_image = cv2.resize(save_image, (400,300)) #reduce size to improve classificator performance
